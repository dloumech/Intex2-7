...
{
    public partial class fagelgamous_databaseContext : DbContext
    {
        public fagelgamous_databaseContext()
        {
        }

        public fagelgamous_databaseContext(DbContextOptions<fagelgamous_databaseContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseNpgsql("Host=localhost;Database=fagelgamous_database;Username=postgres;Password=password");
            }
        }
